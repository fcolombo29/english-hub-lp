...
const courses: Course[] = [
  {
    ...
    description: [
      'Aprendizaje lúdico y dinámico adaptado a su edad',
      'Primer contacto natural con el idioma inglés',
      'Incorporación temprana de vocabulario y estructuras básicas',
      'Desarrollo de la comprensión auditiva y expresión oral',
    ],
    image: childrenClass,
  },
  {
    ...
    description: [
      'Preparación para exámenes internacionales de Cambridge',
      'Herramientas para el futuro académico y laboral',
      'Enfoque en comunicación fluida y natural',
      'Preparación para viajes y experiencias internacionales',
    ],
    image: teensClass,
  },
  {
    ...
    description: [
      'Enfoque comunicativo orientado a resultados',
      'Inglés para contextos laborales y profesionales',
      'Preparación para viajes y situaciones sociales',
...
const CourseCard = ({ course }: { course: Course }) => {
  ...
  return (
    <div className="bg-background rounded-xl shadow-lg overflow-hidden card-hover">
      {/* Image Carousel */}
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="flex items-center gap-2 text-primary font-medium mb-4 hover:text-burgundy-dark transition-colors"
        >
        ...
        <div className="flex items-center gap-2 text-primary font-semibold pt-4 border-t border-border">
          ...
          <span>Consultas: (0221) 423-5678</span>
        </div>
      </div>
    </div>
  );
